  ...
  <form action="" method="POST">
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <select class="form-control" name="assigntech" id="assigntech" required>
          ...
          ?>
              <option value="<?php echo htmlentities($row['empName']); ?>"><?php echo htmlentities($row['empName']); ?></option>
          <?php }
          } ?>
