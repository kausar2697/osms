...
<div class="col-sm-6 mt-5  mx-3">
  <form action="" class="mt-3 form-inline d-print-none">
    <div class="form-group mr-3">
      ...
      <input type="text" class="form-control ml-3" id="checkid" name="checkid" onkeypress="isInputNumber(event)" required>
    </div>
  ...
  if (isset($_REQUEST['checkid'])) {
    ...
    if ($result->num_rows != 0 && ($row['request_id']) == $_REQUEST['checkid']) { ?>
